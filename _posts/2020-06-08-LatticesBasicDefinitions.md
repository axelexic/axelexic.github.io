...
linearly independent over $\RR$ and not just $\ZZ$. That is, not every
free $\ZZ$-module of $\RR$ is a lattice -- the geometry of the space is
just as important.
...
Rank and dimension are crude invariants of a lattice. A more fundamental
invariant is the **volume of a lattice**, which requires a few new
definitions:

```Definition [Fundamental Parallelepiped] {#defn-fundamental-parallelepiped}

Given a lattice basis $\B$, the fundamental parallelepiped is defined as:
$$
